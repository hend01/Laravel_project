                ...
                <div class="intro-y box">
                    ...
                    <div id="input" class="p-5">
                        <div class="preview" style="display: block;">
                            ...
                            <form method="POST" action="{{ route('cars.addCar') }}">
...
Add Car                                        </h2>
                                    ...
                                    <div id="input" class="p-5">
                                        <div>
                                            ...
                                            <input id="make" name="make" type="text" class="form-control @error('make') border border-red-500 @enderror" placeholder="Make">
                                            @error('make')
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input id="model" name="model" type="text" class="form-control @error('model') border border-red-500 @enderror" placeholder="Model">
                                            @error('model')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="year" name="year" type="number" class="form-control @error('year') border border-red-500 @enderror" placeholder="Year">
                                            @error('year')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="color" name="color" type="text" class="form-control @error('color') border border-red-500 @enderror" placeholder="Color">
                                            @error('color')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="license_plate" name="license_plate" type="text" class="form-control @error('license_plate') border border-red-500 @enderror" placeholder="License plate">
                                            @error('license_plate')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="text-right mt-5">
                                            ...
                                            <button type="submit" class="btn btn-primary w-24" id="submitBtn">Enregistrer</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
