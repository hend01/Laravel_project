...
<div class="content">
    ...
    <h2 class="intro-y text-lg font-medium mt-10" style="background-color:#1e40af;color:white;border-radius: 8px;">
        <span style="margin-left: 11px;"> Edit Produit </span>
     </h2>
                                ...
                                <div class="intro-y box">
                                    <div id="input" class="p-5">
                                        <div>
                                            ...
                                            <input id="name" name="name" type="text" class="form-control" value="{{ old('name', $produit->name) }}">
                                            @error('name')
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input id="description" name="description" type="text" class="form-control" value="{{ old('description', $produit->description) }}">
                                            @error('description')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="offer" name="offer" type="offer" class="form-control" value="{{ old('offer', $produit->offer) }}">
                                            @error('offer')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="prix" name="prix" type="number" class="form-control" value="{{ old('prix', $produit->prix) }}">
                                            @error('prix')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
