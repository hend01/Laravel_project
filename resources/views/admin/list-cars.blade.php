...
<div class="content">
    ...
    <a href="{{ route('cars.addCar') }}" class="text-blue-500 add-car-link block" style="position: absolute; top: 212px; left: 290px; z-index: 9999; font-weight: bold; color: #1e40af;">Add new car +</a>
            ...
            <tbody>
                @foreach($cars as $car)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('cars.deleteCar', $car->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger" style="margin-bottom: 4px">Delete</button>
                            </form>
                        
                            <a href="{{ route('cars.edit', $car->id) }}" style="width:66px" class="btn btn-primary">Edit</a>
                            @csrf
                            </form>
                        </td>
