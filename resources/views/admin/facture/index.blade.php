...
<div class="top-bar">
    ...
    <h2 class="intro-y text-lg font-medium mt-8" style="background-color:#1e40af;color:white;border-radius: 8px;">
            <span style="margin-left: 11px;"> Liste des Factures </span>
         </h2> 
         <a href="{{ route('admin.facture.upload') }}" class="text-blue-500 add-car-link block" style=" top: 140px; left: 290px; z-index: 9999; font-weight: bold; color: #1e40af;">Generate Factures +</a>
