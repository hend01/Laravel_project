                                ...
                                <div class="intro-y box">
                                    <div id="input" class="p-5">
                                        <div>
                                            ...
                                            <input id="first_name" name="first_name" type="text" class="form-control" value="{{ old('first_name', $driver->first_name) }}">
                                            @error('first_name')
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input id="last_name" name="last_name" type="text" class="form-control" value="{{ old('last_name', $driver->last_name) }}">
                                            @error('last_name')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="email" name="email" type="email" class="form-control" value="{{ old('email', $driver->email) }}">
                                            @error('email')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="phone_number" name="phone_number" type="text" class="form-control" value="{{ old('phone_number', $driver->phone_number) }}">
                                            @error('phone_number')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <input id="birth_date" name="birth_date" type="date" class="form-control" value="{{ old('birth_date', $driver->birth_date) }}">
                                            @error('birth_date')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
