...
<div class="content">
    ...
    <!-- END: Top Bar -->
        <h2 class="intro-y text-lg font-medium mt-10" style="background-color:#1e40af;color:white;border-radius: 8px;">
            <span style="margin-left: 11px;"> Add Driver </span>
         </h2>
                        ...
                        <div class="intro-y box">
                            <div id="input" class="p-5">
                                <div class="preview" style="display: block;">
                                    <form method="POST" action="{{ route('drivers.addDriver') }}">
                                        ...
                                        <div class="intro-y box">
                                            ...
                                            <div id="input" class="p-5">
                                                <div>
                                                    ...
                                                    <input id="first_name" name="first_name" type="text" class="form-control @error('first_name') border border-red-500 @enderror" placeholder="First Name">
                                                    @error('first_name')
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input id="last_name" name="last_name" type="text" class="form-control @error('last_name') border border-red-500 @enderror" placeholder="Last Name">
                                                    @error('last_name')
                                                    <p class="text-red-500 mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                <div class="mt-3">
                                                    ...
                                                    <input id="email" name="email" type="email" class="form-control @error('email') border border-red-500 @enderror" placeholder="Email">
                                                    @error('email')
                                                    <p class="text-red-500 mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                <div class="mt-3">
                                                    ...
                                                    <input id="phone_number" name="phone_number" type="text" class="form-control @error('phone_number') border border-red-500 @enderror" placeholder="Phone Number">
                                                    @error('phone_number')
                                                    <p class="text-red-500 mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                <div class="mt-3">
                                                    ...
                                                    <input id="birth_date" name="birth_date" type="date" class="form-control @error('birth_date') border border-red-500 @enderror">
                                                    @error('birth_date')
                                                    <p class="text-red-500 mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                <div class="mt-3">
                                                    ...
                                                    <select id="gender" name="gender" class="form-select @error('gender') border border-red-500 @enderror">
                                                ...
                                                <div class="text-right mt-5">
                                                    ...
                                                    <button type="submit" class="btn btn-primary w-24" id="submitBtn">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
