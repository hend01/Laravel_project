...
<div class="top-bar">
 ...
 <h2 class="intro-y text-lg font-medium mt-10" style="background-color:#1e40af;color:white;border-radius: 8px;">
         ...
         <a href="{{ route('entretiens.create') }}" class="text-blue-500 add-car-link block" style=" top: 212px; left: 290px; z-index: 9999; font-weight: bold; color: #1e40af;">Add Entretien +</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach($entretiens as $entretien)
                <tr>
                    <td>{{ $entretien->id }}</td>
                    <td>{{ $entretien->car_id }}</td> <!-- Affichez l'ID de la voiture associée -->
