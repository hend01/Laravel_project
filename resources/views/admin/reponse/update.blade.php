...
<div class="content">
    ...
    <!-- END: Top Bar -->
        <h2 class="intro-y text-lg font-medium mt-10" style="background-color:#1e40af;color:white;border-radius: 8px;">
            <span style="margin-left: 11px;"> Modifier une Reponse </span>
         </h2>
                ...
                <div class="intro-y box">
                    ...
                    <div id="input" class="p-5">
                        <div class="preview" style="display: block;">
                            ...
                            <form method="post" action="{{ route('admin.reponses.update', $reponse->id) }}">
                                ...
                                <div>
                                    ...
                                    <textarea name="contenu" id="contenu" class="form-control" rows="4" placeholder="Contenu de la réponse">{{ $reponse->contenu }}</textarea>
