...
<div class="content">
    ...
    <h2 class="intro-y text-lg font-medium mt-10" style="background-color:#1e40af;color:white;border-radius: 8px;">
        <span style="margin-left: 11px;"> Edit event </span>
     </h2>
                                ...
                                <div class="intro-y box">
                                    <div id="input" class="p-5">
                                        <div>
                                            ...
                                            <input id="name" name="name" type="text" class="form-control" value="{{ old('name', $event->name) }}">
                                            @error('name')
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <textarea id="description" name="description" type="text" class="form-control" value="{{ old('description', $event->description) }}"></textarea>
                                            @error('description')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            <label for="produit_number" class="form-label">produit_number</label>
                                            <input id="produit_number" name="produit_number" type="number" class="form-control" value="{{ old('produit_number', $event->produit_number) }}">
                                            @error('produit_number')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mt-3">
                                            <label for="event_type" class="form-label">event_type</label>
                                            <input id="event_type" name="event_type" type="text" class="form-control" value="{{ old('event_type', $event->event_type) }}">
                                            @error('event_type')
                                            <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
