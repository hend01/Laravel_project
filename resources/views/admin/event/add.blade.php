    ...
    <div class="theme-container container">
        <div class="col-md-10 col-sm-6 col-md-offset-1 contact-form">
            <div class="calculate-form">
                <form class="row" action="{{ route('event.store') }}" method="POST" id="contact-form">
                    @csrf
                    ...
                    <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
                        <div class="col-sm-3">
                            <label class="title-2">event_type:</label>
                        </div>
                        <div class="col-sm-9">
                            <input type="text" name="event_type" id="event_type" required placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
                        <div class="col-sm-3">
                            <label class="title-2">produit_number: </label>
                        </div>
                        <div class="col-sm-9">
                            <input type="text" name="produit_number" id="produit_number" required placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
